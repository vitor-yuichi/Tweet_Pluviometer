...
Atualmente os principais algoritmos empregados para classificação são o \textit{Suport Vector Machine} (SVMs) e \textit{Random Forest} \cite{mohri2018foundations}.
...
%-----------------
\subsection{Floresta Aleatória (\textit{Random Forest})}
